...
**Security Professional → AI Security and Compliance Engineering**
...
> Most compliance engineers can tell you what a control requires. Fewer can build the tool
> that checks it automatically. That gap is what this portfolio is closing.
